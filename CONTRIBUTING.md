...
1. Ensure any install or build dependencies are updated and at least one installation package (under your development environment) can be built.
2. Update the README.md with details of changes to the interface, this includes screenshots, feature and usage descriptions.
