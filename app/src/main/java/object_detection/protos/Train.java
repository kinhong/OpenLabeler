...
public final class Train {
  ...
  /**
   * Protobuf enum {@code object_detection.protos.CheckpointVersion}
   */
  public enum CheckpointVersion
    ...
    public static CheckpointVersion valueOf(int value) {
     ...
     * @return The enum associated with the given numeric wire value.
     */
    public static CheckpointVersion forNumber(int value) {
      switch (value) {
    ...
    public static com.google.protobuf.Internal.EnumLiteMap<CheckpointVersion>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        CheckpointVersion> internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<CheckpointVersion>() {
            public CheckpointVersion findValueByNumber(int number) {
              return CheckpointVersion.forNumber(number);
            }
          };
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return object_detection.protos.Train.getDescriptor().getEnumTypes().get(0);
    }

    private static final CheckpointVersion[] VALUES = values();

    public static CheckpointVersion valueOf(
    ...
    private CheckpointVersion(int value) {
      this.value = value;
    }

    // @@protoc_insertion_point(enum_scope:object_detection.protos.CheckpointVersion)
  }
  ...
  public interface TrainConfigOrBuilder extends
     ...
     * @return Whether the syncReplicas field is set.
     */
     ...
     * @return Whether the keepCheckpointEveryNHours field is set.
     */
     ...
     * @return Whether the gradientClippingByNorm field is set.
     */
     ...
     *
     * <code>optional float gradient_clipping_by_norm = 6 [default = 0];</code>
     * @return The gradientClippingByNorm.
     */
     ...
     * @return Whether the fineTuneCheckpoint field is set.
     */
     ...
     *
     * <code>optional string fine_tune_checkpoint = 7 [default = ""];</code>
     * @return The bytes for fineTuneCheckpoint.
     */
     ...
     * @return Whether the fineTuneCheckpointType field is set.
     */
     ...
     *
     * <code>optional string fine_tune_checkpoint_type = 22 [default = ""];</code>
     * @return The fineTuneCheckpointType.
     */
     ...
     *
     * <code>optional string fine_tune_checkpoint_type = 22 [default = ""];</code>
     * @return The bytes for fineTuneCheckpointType.
     */
    com.google.protobuf.ByteString
     ...
     * </pre>
     *
     * <code>optional .object_detection.protos.CheckpointVersion fine_tune_checkpoint_version = 28 [default = V1];</code>
     * @return Whether the fineTuneCheckpointVersion field is set.
     */
    boolean hasFineTuneCheckpointVersion();
    /**
     * <pre>
     * Either "v1" or "v2". If v1, restores the checkpoint using the tensorflow
     * v1 style of restoring checkpoints. If v2, uses the eager mode checkpoint
     ...
     *
     * <code>optional .object_detection.protos.CheckpointVersion fine_tune_checkpoint_version = 28 [default = V1];</code>
     * @return The fineTuneCheckpointVersion.
     */
    object_detection.protos.Train.CheckpointVersion getFineTuneCheckpointVersion();
     ...
     * @return Whether the fromDetectionCheckpoint field is set.
     */
     ...
     *
     * <code>optional bool from_detection_checkpoint = 8 [default = false, deprecated = true];</code>
     * @return The fromDetectionCheckpoint.
     */
     ...
     * @return Whether the loadAllDetectionCheckpointVars field is set.
     */
     ...
     *
     * <code>optional bool load_all_detection_checkpoint_vars = 19 [default = false];</code>
     * @return The loadAllDetectionCheckpointVars.
     */
     ...
     * @return Whether the numSteps field is set.
     */
    boolean hasNumSteps();
    /**
     * <pre>
     ...
     * @return Whether the startupDelaySteps field is set.
     */
     ...
     * @return Whether the biasGradMultiplier field is set.
     */
     ...
     * @return A list containing the updateTrainableVariables.
     */
     ...
     *
     * <code>repeated string update_trainable_variables = 25;</code>
     * @return The count of updateTrainableVariables.
     */
     ...
     * @return The updateTrainableVariables at the given index.
     */
     ...
     * @return The bytes of the updateTrainableVariables at the given index.
     */
    com.google.protobuf.ByteString
     ...
     * @return A list containing the freezeVariables.
     */
    java.util.List<java.lang.String>
     ...
     *
     * <code>repeated string freeze_variables = 12;</code>
     * @return The count of freezeVariables.
     */
     ...
     * <code>repeated string freeze_variables = 12;</code>
     * @param index The index of the element to return.
     * @return The freezeVariables at the given index.
     */
     ...
     * <code>repeated string freeze_variables = 12;</code>
     * @param index The index of the value to return.
     * @return The bytes of the freezeVariables at the given index.
     */
    com.google.protobuf.ByteString
     ...
     * @return Whether the replicasToAggregate field is set.
     */
     ...
     *
     * <code>optional int32 replicas_to_aggregate = 13 [default = 1];</code>
     * @return The replicasToAggregate.
     */
     ...
     * </pre>
     *
     * <code>optional int32 batch_queue_capacity = 14 [default = 150, deprecated = true];</code>
     * @return Whether the batchQueueCapacity field is set.
     */
    @java.lang.Deprecated boolean hasBatchQueueCapacity();
    /**
     * <pre>
     * Maximum number of elements to store within a queue.
     * </pre>
     *
     * <code>optional int32 batch_queue_capacity = 14 [default = 150, deprecated = true];</code>
     * @return The batchQueueCapacity.
     */
    @java.lang.Deprecated int getBatchQueueCapacity();
     ...
     * </pre>
     *
     * <code>optional int32 num_batch_queue_threads = 15 [default = 8, deprecated = true];</code>
     * @return Whether the numBatchQueueThreads field is set.
     */
    @java.lang.Deprecated boolean hasNumBatchQueueThreads();
    /**
     * <pre>
     * Number of threads to use for batching.
     * </pre>
     *
     * <code>optional int32 num_batch_queue_threads = 15 [default = 8, deprecated = true];</code>
     * @return The numBatchQueueThreads.
     */
    @java.lang.Deprecated int getNumBatchQueueThreads();
     ...
     * </pre>
     *
     * <code>optional int32 prefetch_queue_capacity = 16 [default = 5, deprecated = true];</code>
     * @return Whether the prefetchQueueCapacity field is set.
     */
    @java.lang.Deprecated boolean hasPrefetchQueueCapacity();
    /**
     * <pre>
     * Maximum capacity of the queue used to prefetch assembled batches.
     * </pre>
     *
     * <code>optional int32 prefetch_queue_capacity = 16 [default = 5, deprecated = true];</code>
     * @return The prefetchQueueCapacity.
     */
    @java.lang.Deprecated int getPrefetchQueueCapacity();
     ...
     * @return Whether the mergeMultipleLabelBoxes field is set.
     */
     ...
     *
     * <code>optional bool merge_multiple_label_boxes = 17 [default = false];</code>
     * @return The mergeMultipleLabelBoxes.
     */
     ...
     * @return Whether the useMulticlassScores field is set.
     */
     ...
     *
     * <code>optional bool use_multiclass_scores = 24 [default = false];</code>
     * @return The useMulticlassScores.
     */
     ...
     * @return Whether the addRegularizationLoss field is set.
     */
     ...
     *
     * <code>optional bool add_regularization_loss = 18 [default = true];</code>
     * @return The addRegularizationLoss.
     */
     ...
     * @return Whether the unpadGroundtruthTensors field is set.
     */
     ...
     *
     * <code>optional bool unpad_groundtruth_tensors = 21 [default = true];</code>
     * @return The unpadGroundtruthTensors.
     */
     ...
     * @return Whether the useBfloat16 field is set.
     */
     ...
     * @return Whether the summarizeGradients field is set.
     */
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 224: {
              ...
              object_detection.protos.Train.CheckpointVersion value = object_detection.protos.Train.CheckpointVersion.valueOf(rawValue);
              if (value == null) {
                unknownFields.mergeVarintField(28, rawValue);
              } else {
                bitField0_ |= 0x00000080;
                fineTuneCheckpointVersion_ = rawValue;
              }
              break;
            }
            default: {
    ...
    public static final int FINE_TUNE_CHECKPOINT_VERSION_FIELD_NUMBER = 28;
    private int fineTuneCheckpointVersion_;
    /**
     * <pre>
     * Either "v1" or "v2". If v1, restores the checkpoint using the tensorflow
     * v1 style of restoring checkpoints. If v2, uses the eager mode checkpoint
     ...
     * @return Whether the fineTuneCheckpointVersion field is set.
     */
    @java.lang.Override public boolean hasFineTuneCheckpointVersion() {
     ...
     * @return The fineTuneCheckpointVersion.
     */
    @java.lang.Override public object_detection.protos.Train.CheckpointVersion getFineTuneCheckpointVersion() {
      @SuppressWarnings("deprecation")
      object_detection.protos.Train.CheckpointVersion result = object_detection.protos.Train.CheckpointVersion.valueOf(fineTuneCheckpointVersion_);
      return result == null ? object_detection.protos.Train.CheckpointVersion.V1 : result;
    }
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean hasBatchQueueCapacity() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public int getBatchQueueCapacity() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean hasNumBatchQueueThreads() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public int getNumBatchQueueThreads() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public boolean hasPrefetchQueueCapacity() {
     ...
     */
    @java.lang.Override
    @java.lang.Deprecated public int getPrefetchQueueCapacity() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000080) != 0)) {
        output.writeEnum(28, fineTuneCheckpointVersion_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000080) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(28, fineTuneCheckpointVersion_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getDataAugmentationOptionsList()
          .equals(other.getDataAugmentationOptionsList())) return false;
      if (hasSyncReplicas() != other.hasSyncReplicas()) return false;
      if (hasSyncReplicas()) {
        if (getSyncReplicas()
            != other.getSyncReplicas()) return false;
      }
      if (hasKeepCheckpointEveryNHours() != other.hasKeepCheckpointEveryNHours()) return false;
      ...
      if (hasFineTuneCheckpointType() != other.hasFineTuneCheckpointType()) return false;
      if (hasFineTuneCheckpointType()) {
        if (!getFineTuneCheckpointType()
            .equals(other.getFineTuneCheckpointType())) return false;
      }
      if (hasFineTuneCheckpointVersion() != other.hasFineTuneCheckpointVersion()) return false;
      if (hasFineTuneCheckpointVersion()) {
        if (fineTuneCheckpointVersion_ != other.fineTuneCheckpointVersion_) return false;
      }
      if (hasFromDetectionCheckpoint() != other.hasFromDetectionCheckpoint()) return false;
      if (hasFromDetectionCheckpoint()) {
        if (getFromDetectionCheckpoint()
            != other.getFromDetectionCheckpoint()) return false;
      }
      if (hasLoadAllDetectionCheckpointVars() != other.hasLoadAllDetectionCheckpointVars()) return false;
      if (hasLoadAllDetectionCheckpointVars()) {
        if (getLoadAllDetectionCheckpointVars()
            != other.getLoadAllDetectionCheckpointVars()) return false;
      }
      ...
      if (hasBiasGradMultiplier() != other.hasBiasGradMultiplier()) return false;
      if (hasBiasGradMultiplier()) {
        if (java.lang.Float.floatToIntBits(getBiasGradMultiplier())
            != java.lang.Float.floatToIntBits(
                other.getBiasGradMultiplier())) return false;
      }
      if (!getUpdateTrainableVariablesList()
          .equals(other.getUpdateTrainableVariablesList())) return false;
      if (!getFreezeVariablesList()
          .equals(other.getFreezeVariablesList())) return false;
      if (hasReplicasToAggregate() != other.hasReplicasToAggregate()) return false;
      if (hasReplicasToAggregate()) {
        if (getReplicasToAggregate()
            != other.getReplicasToAggregate()) return false;
      }
      if (hasBatchQueueCapacity() != other.hasBatchQueueCapacity()) return false;
      if (hasBatchQueueCapacity()) {
        if (getBatchQueueCapacity()
            != other.getBatchQueueCapacity()) return false;
      }
      if (hasNumBatchQueueThreads() != other.hasNumBatchQueueThreads()) return false;
      if (hasNumBatchQueueThreads()) {
        if (getNumBatchQueueThreads()
            != other.getNumBatchQueueThreads()) return false;
      }
      if (hasPrefetchQueueCapacity() != other.hasPrefetchQueueCapacity()) return false;
      if (hasPrefetchQueueCapacity()) {
        if (getPrefetchQueueCapacity()
            != other.getPrefetchQueueCapacity()) return false;
      }
      if (hasMergeMultipleLabelBoxes() != other.hasMergeMultipleLabelBoxes()) return false;
      if (hasMergeMultipleLabelBoxes()) {
        if (getMergeMultipleLabelBoxes()
            != other.getMergeMultipleLabelBoxes()) return false;
      }
      if (hasUseMulticlassScores() != other.hasUseMulticlassScores()) return false;
      if (hasUseMulticlassScores()) {
        if (getUseMulticlassScores()
            != other.getUseMulticlassScores()) return false;
      }
      if (hasAddRegularizationLoss() != other.hasAddRegularizationLoss()) return false;
      if (hasAddRegularizationLoss()) {
        if (getAddRegularizationLoss()
            != other.getAddRegularizationLoss()) return false;
      }
      ...
      if (hasUnpadGroundtruthTensors() != other.hasUnpadGroundtruthTensors()) return false;
      if (hasUnpadGroundtruthTensors()) {
        if (getUnpadGroundtruthTensors()
            != other.getUnpadGroundtruthTensors()) return false;
      }
      ...
      if (hasUseBfloat16() != other.hasUseBfloat16()) return false;
      if (hasUseBfloat16()) {
        if (getUseBfloat16()
            != other.getUseBfloat16()) return false;
      }
      if (hasSummarizeGradients() != other.hasSummarizeGradients()) return false;
      if (hasSummarizeGradients()) {
        if (getSummarizeGradients()
            != other.getSummarizeGradients()) return false;
      }
    ...
    public int hashCode() {
      ...
      if (hasFineTuneCheckpointVersion()) {
        hash = (37 * hash) + FINE_TUNE_CHECKPOINT_VERSION_FIELD_NUMBER;
        hash = (53 * hash) + fineTuneCheckpointVersion_;
      }
      if (hasFromDetectionCheckpoint()) {
    ...
    public static final class Builder extends
      ...
      public object_detection.protos.Train.TrainConfig buildPartial() {
        ...
        result.fineTuneCheckpointVersion_ = fineTuneCheckpointVersion_;
      ...
      public Builder mergeFrom(object_detection.protos.Train.TrainConfig other) {
        ...
        if (other.hasFineTuneCheckpointVersion()) {
          setFineTuneCheckpointVersion(other.getFineTuneCheckpointVersion());
        }
       ...
       *
       * <code>optional float gradient_clipping_by_norm = 6 [default = 0];</code>
       * @param value The gradientClippingByNorm to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional string fine_tune_checkpoint = 7 [default = ""];</code>
       * @param value The fineTuneCheckpoint to set.
       * @return This builder for chaining.
       */
  ...
  bitField0_ |= 0x00000040;
       ...
       *
       * <code>optional string fine_tune_checkpoint = 7 [default = ""];</code>
       * @param value The bytes for fineTuneCheckpoint to set.
       * @return This builder for chaining.
       */
  ...
  bitField0_ |= 0x00000040;
       ...
       *
       * <code>optional string fine_tune_checkpoint_type = 22 [default = ""];</code>
       * @param value The fineTuneCheckpointType to set.
       * @return This builder for chaining.
       */
  ...
  bitField0_ |= 0x00000080;
       ...
       *
       * <code>optional string fine_tune_checkpoint_type = 22 [default = ""];</code>
       * @param value The bytes for fineTuneCheckpointType to set.
       * @return This builder for chaining.
       */
  ...
  bitField0_ |= 0x00000080;
      ...
      private int fineTuneCheckpointVersion_ = 1;
      /**
       * <pre>
       * Either "v1" or "v2". If v1, restores the checkpoint using the tensorflow
       * v1 style of restoring checkpoints. If v2, uses the eager mode checkpoint
       ...
       */
      @java.lang.Override
      public object_detection.protos.Train.CheckpointVersion getFineTuneCheckpointVersion() {
        @SuppressWarnings("deprecation")
        object_detection.protos.Train.CheckpointVersion result = object_detection.protos.Train.CheckpointVersion.valueOf(fineTuneCheckpointVersion_);
        return result == null ? object_detection.protos.Train.CheckpointVersion.V1 : result;
      }
       ...
       *
       * <code>optional .object_detection.protos.CheckpointVersion fine_tune_checkpoint_version = 28 [default = V1];</code>
       * @param value The fineTuneCheckpointVersion to set.
       * @return This builder for chaining.
       */
      public Builder setFineTuneCheckpointVersion(object_detection.protos.Train.CheckpointVersion value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000100;
        fineTuneCheckpointVersion_ = value.getNumber();
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearFineTuneCheckpointVersion() {
        bitField0_ = (bitField0_ & ~0x00000100);
        fineTuneCheckpointVersion_ = 1;
        onChanged();
        return this;
       ...
       *
       * <code>optional bool from_detection_checkpoint = 8 [default = false, deprecated = true];</code>
       * @param value The fromDetectionCheckpoint to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool load_all_detection_checkpoint_vars = 19 [default = false];</code>
       * @param value The loadAllDetectionCheckpointVars to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional float startup_delay_steps = 10 [default = 15];</code>
       * @param value The startupDelaySteps to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional float bias_grad_multiplier = 11 [default = 0];</code>
       * @param value The biasGradMultiplier to set.
       * @return This builder for chaining.
       */
       ...
       * @param value The updateTrainableVariables to set.
       * @return This builder for chaining.
       */
  ...
  ensureUpdateTrainableVariablesIsMutable();
       ...
       *
       * <code>repeated string update_trainable_variables = 25;</code>
       * @param value The updateTrainableVariables to add.
       * @return This builder for chaining.
       */
  ...
  ensureUpdateTrainableVariablesIsMutable();
       ...
       *
       * <code>repeated string update_trainable_variables = 25;</code>
       * @param values The updateTrainableVariables to add.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>repeated string update_trainable_variables = 25;</code>
       * @param value The bytes of the updateTrainableVariables to add.
       * @return This builder for chaining.
       */
  ...
  ensureUpdateTrainableVariablesIsMutable();
       ...
       * <code>repeated string freeze_variables = 12;</code>
       * @param index The index to set the value at.
       * @param value The freezeVariables to set.
       * @return This builder for chaining.
       */
  ...
  ensureFreezeVariablesIsMutable();
       ...
       *
       * <code>repeated string freeze_variables = 12;</code>
       * @param value The freezeVariables to add.
       * @return This builder for chaining.
       */
  ...
  ensureFreezeVariablesIsMutable();
       ...
       *
       * <code>repeated string freeze_variables = 12;</code>
       * @param values The freezeVariables to add.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>repeated string freeze_variables = 12;</code>
       * @param value The bytes of the freezeVariables to add.
       * @return This builder for chaining.
       */
  ...
  ensureFreezeVariablesIsMutable();
       ...
       *
       * <code>optional int32 replicas_to_aggregate = 13 [default = 1];</code>
       * @param value The replicasToAggregate to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional int32 batch_queue_capacity = 14 [default = 150, deprecated = true];</code>
       * @param value The batchQueueCapacity to set.
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder setBatchQueueCapacity(int value) {
        bitField0_ |= 0x00020000;
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder clearBatchQueueCapacity() {
        bitField0_ = (bitField0_ & ~0x00020000);
        batchQueueCapacity_ = 150;
        onChanged();
        return this;
       ...
       *
       * <code>optional int32 num_batch_queue_threads = 15 [default = 8, deprecated = true];</code>
       * @param value The numBatchQueueThreads to set.
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder setNumBatchQueueThreads(int value) {
        bitField0_ |= 0x00040000;
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder clearNumBatchQueueThreads() {
        bitField0_ = (bitField0_ & ~0x00040000);
        numBatchQueueThreads_ = 8;
        onChanged();
        return this;
       ...
       *
       * <code>optional int32 prefetch_queue_capacity = 16 [default = 5, deprecated = true];</code>
       * @param value The prefetchQueueCapacity to set.
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder setPrefetchQueueCapacity(int value) {
        bitField0_ |= 0x00080000;
       ...
       * @return This builder for chaining.
       */
      @java.lang.Deprecated public Builder clearPrefetchQueueCapacity() {
        bitField0_ = (bitField0_ & ~0x00080000);
        prefetchQueueCapacity_ = 5;
        onChanged();
        return this;
       ...
       *
       * <code>optional bool merge_multiple_label_boxes = 17 [default = false];</code>
       * @param value The mergeMultipleLabelBoxes to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool use_multiclass_scores = 24 [default = false];</code>
       * @param value The useMulticlassScores to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool add_regularization_loss = 18 [default = true];</code>
       * @param value The addRegularizationLoss to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool unpad_groundtruth_tensors = 21 [default = true];</code>
       * @param value The unpadGroundtruthTensors to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool use_bfloat16 = 26 [default = false];</code>
       * @param value The useBfloat16 to set.
       * @return This builder for chaining.
       */
       ...
       *
       * <code>optional bool summarize_gradients = 27 [default = false];</code>
       * @param value The summarizeGradients to set.
       * @return This builder for chaining.
       */
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "n/protos/preprocessor.proto\"\367\010\n\013TrainCon" +
      ...
      "_checkpoint_type\030\026 \001(\t:\000\022T\n\034fine_tune_ch" +
      "eckpoint_version\030\034 \001(\0162*.object_detectio" +
      "n.protos.CheckpointVersion:\002V1\022,\n\031from_d" +
      "etection_checkpoint\030\010 \001(\010:\005falseB\002\030\001\0221\n\"" +
      "load_all_detection_checkpoint_vars\030\023 \001(\010" +
      ":\005false\022\024\n\tnum_steps\030\t \001(\r:\0010\022\037\n\023startup" +
      "_delay_steps\030\n \001(\002:\00215\022\037\n\024bias_grad_mult" +
      "iplier\030\013 \001(\002:\0010\022\"\n\032update_trainable_vari" +
      "ables\030\031 \003(\t\022\030\n\020freeze_variables\030\014 \003(\t\022 \n" +
      "\025replicas_to_aggregate\030\r \001(\005:\0011\022%\n\024batch" +
      "_queue_capacity\030\016 \001(\005:\003150B\002\030\001\022&\n\027num_ba" +
      "tch_queue_threads\030\017 \001(\005:\0018B\002\030\001\022&\n\027prefet" +
      "ch_queue_capacity\030\020 \001(\005:\0015B\002\030\001\022)\n\032merge_" +
      "multiple_label_boxes\030\021 \001(\010:\005false\022$\n\025use" +
      "_multiclass_scores\030\030 \001(\010:\005false\022%\n\027add_r" +
      "egularization_loss\030\022 \001(\010:\004true\022$\n\023max_nu" +
      "mber_of_boxes\030\024 \001(\005:\003100B\002\030\001\022\'\n\031unpad_gr" +
      "oundtruth_tensors\030\025 \001(\010:\004true\022%\n\026retain_" +
      "original_images\030\027 \001(\010:\005false\022\033\n\014use_bflo" +
      "at16\030\032 \001(\010:\005false\022\"\n\023summarize_gradients" +
      "\030\033 \001(\010:\005false*0\n\021CheckpointVersion\022\013\n\007UN" +
    ...
    internal_static_object_detection_protos_TrainConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_object_detection_protos_TrainConfig_descriptor,
        new java.lang.String[] { "BatchSize", "DataAugmentationOptions", "SyncReplicas", "KeepCheckpointEveryNHours", "Optimizer", "GradientClippingByNorm", "FineTuneCheckpoint", "FineTuneCheckpointType", "FineTuneCheckpointVersion", "FromDetectionCheckpoint", "LoadAllDetectionCheckpointVars", "NumSteps", "StartupDelaySteps", "BiasGradMultiplier", "UpdateTrainableVariables", "FreezeVariables", "ReplicasToAggregate", "BatchQueueCapacity", "NumBatchQueueThreads", "PrefetchQueueCapacity", "MergeMultipleLabelBoxes", "UseMulticlassScores", "AddRegularizationLoss", "MaxNumberOfBoxes", "UnpadGroundtruthTensors", "RetainOriginalImages", "UseBfloat16", "SummarizeGradients", });
    object_detection.protos.OptimizerOuterClass.getDescriptor();
    object_detection.protos.Preprocessor.getDescriptor();
  }
