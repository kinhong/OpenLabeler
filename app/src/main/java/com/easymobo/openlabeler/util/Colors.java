/*
 * Copyright (c) 2020. Infolytik. All rights reserved.
 */
...
{
   /**
    * Courtesy of <a href="https://stackoverflow.com/a/12224359">this SO answer</a>
    */
   private static final String[] hexColors = new String[]{
   ...
   public static final List<Color> distinctColors = Arrays.asList(hexColors).stream().map(s -> Color.web(s)).collect(Collectors.toList());
   ...
   public static double distance(final Color lhs, final Color rhs) {
      return Math.pow(lhs.getRed() - rhs.getRed(), 2) +
             Math.pow(lhs.getGreen() - rhs.getGreen(), 2) +
             Math.pow(lhs.getBlue() - rhs.getBlue(), 2);
   }

   public static String toRGBA(final Color color, double alpha) {
