...
public class ModelUtil
{
    ...
    public static class OneBasedCoordAdapter extends XmlAdapter<Integer, Double>
    {
        @Override
        public Double unmarshal(Integer s) {
            return s.doubleValue() - 1.0;
        }
    ...
    public static class CoordAdapter extends XmlAdapter<Integer, Double>
    {
        @Override
        public Double unmarshal(Integer s) {
